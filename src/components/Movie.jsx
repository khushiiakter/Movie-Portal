  ...
  return (
    <div className="  text-white rounded-2xl shadow-md overflow-hidden">
      ...
      <div className="relative ">
        <img className="w-full h-[470px] object-cover" src={poster} alt={title} />

        <div className="flex items-center absolute bottom-[0px] pl-5 pb-4">
          {/* Title and Rating */}
          <h3 className="text-3xl  font-bold ">{title}</h3>
          {/* Rating Number */}
          <span className="ml-2 font-medium text-red-400 text-base">({rating})</span>
        </div>
      </div>
      

      {/* Movie Info */}
      <div className="py-4 bg-gray-900 px-5 flex  items-center justify-between">
